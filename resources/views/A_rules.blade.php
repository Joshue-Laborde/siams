            ...
            <div class="row">
                ...
                <div class="col-sm">
                    ...
                    <div class="col-md-6 col-sm-6 " style="text-align: center;">
                        ...
                        <div id="image">
                            <img id="graphic" width="400" height="400"
                    ...
                    <div class="col-md-6 col-sm-6 " style="text-align: center;">
                        ...
                        <div id="image">
                            <img id="plot" width="400" height="400"
                                src="{{ asset('img/img_arules/blanco.png') }}">
                        </div>
                        <div>
                            <h7 id="textoplot"></h7>
                    ...
                    <div class="col-md-6 col-sm-6 " style="text-align: center;">
                        ...
                        <div id="image">
                            <img id="graphic3" width="400" height="500"
                                src="{{ asset('img/img_arules/blanco.png') }}">
                        </div>
                        <div>
    ...
    <script>
        ...
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        document.getElementById("graphic").src =
                            "/img/img_arules/codo_jambu.png?";
                        document.getElementById("textographic").innerHTML =
                            "Minimización de la varianza intra-cluster y la maximización de la varianza inter-cluster";
                        //Gráfica 2
                        document.getElementById("Title_grafic2").innerHTML =
                            "Distribución de datos";
                        document.getElementById("plot").src =
                            "/img/img_arules/distribucion.png?";
                        document.getElementById("textoplot").innerHTML = "En relación a los " +
                            cluster +
                            " clusters deseados, se muestra como se distribuyen los puntos en un plano cartesiano";
                        //Gráfica 3
                        document.getElementById("Title_grafic3").innerHTML =
                            "Gráfica Distribución de Trayectorias.";
                        document.getElementById("graphic3").src =
                        "/img/img_arules/density.png?";
            ...
            $("#consulta").click(function() {
                ...
                /// ESTO ES PARA EL MAPA DE GOOGLE MAPS
